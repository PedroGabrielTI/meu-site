export default async function handler(req, res) {
  ...
  try {
    ...
    // Respeita o tipo de pagamento enviado pelo frontend.
    // Valores válidos: 'credit_card' | 'debit_card'
    // Se não informado, padrão é 'credit_card' (comportamento anterior mantido).
    ...
    console.log('[mp-point-create] payment.type:', paymentType, '| amount:', payload.amount);
    ...
    console.log('[mp-point-create] MP status:', response.status, '| message:', data?.message || '');
